...
export function DirectBookingWidget() {
  ...
  return (
    <article className="bg-white border border-cream-200/50 p-6 md:p-8 rounded-sm shadow-[0_20px_50px_rgba(201,168,122,0.08)] select-none animate-fade-in transition-all hover:border-gold-500/20 hover:shadow-[0_20px_50px_rgba(201,168,122,0.12)] flex flex-col justify-center gap-6 md:gap-7 w-full h-full max-w-4xl mx-auto text-left">
