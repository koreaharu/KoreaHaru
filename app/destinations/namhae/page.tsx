...
const NAMHAE_SPOTS = [
  {
    ...
    image: '/images/destinations/namhae_boriam.png',
  ...
  },
  {
    ...
    image: '/images/destinations/namhae_darangee.png',
    type: 'Scenic Village',
  },
  {
    slug: 'german',
      ...
      <Section tone="cream" className="border-t border-cream-200 bg-cream-100/40">
        <Container>
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <h2 className="mt-4 font-serif text-3xl font-light text-ink-900 md:text-5xl">Featured: Namhae Signature Heritage Tour</h2>
            <p className="mt-4 text-ink-600 max-w-2xl mx-auto text-sm leading-relaxed">
              We have designed the ultimate signature route along Namhae's spectacular jagged peaks and fairytale coastline. Experience a perfect blend of high clifftop sanctuaries, hand-carved stone rice paddies, and enclaves of European culture.
            </p>
          </div>
          ...
          <div className="bg-white border border-cream-200 p-6 md:p-8 rounded-sm shadow-sm max-w-4xl mx-auto">
              ...
              <div className="flex-1 bg-cream-50/50 p-6 border border-cream-200 rounded-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-serif text-base font-semibold text-ink-900">Heritage, Cliffs & Fairytales</h4>
                  </div>
                  <ul className="space-y-4 text-xs text-ink-700">
                    <li className="flex gap-2">
                      <span className="text-gold-600 font-bold">09:00 AM</span>
                      <span>❶ <strong>Geumsan Boriam Hermitage</strong> (Clifftop mountain sanctuary & Geumsan Sanjang hot cabin ramyun)</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-gold-600 font-bold">12:00 PM</span>
                      <span>❷ <strong>Gacheon Darangee Village</strong> (108 tiers of hand-carved paddies & local Yuja rice wine)</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-gold-600 font-bold">02:30 PM</span>
                      <span>❸ <strong>Namhae German Village</strong> (Orange-roofed fairytale enclaves, sausages & ocean lounge craft beers)</span>
                    </li>
                  </ul>
                </div>
              </div>

              {/* Alternative Scenic Card */}
              <div className="flex-1 bg-cream-50/50 p-6 border border-cream-200 rounded-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    <span className="text-[10px] font-bold bg-gold-600 text-white px-2 py-0.5 rounded-sm uppercase tracking-wider">Alternative Route</span>
                    <h4 className="font-serif text-base font-semibold text-ink-900">Nature & Ocean Healing Escape</h4>
                  </div>
                  <p className="text-xs text-ink-600 leading-relaxed mb-4">
                    Looking for a slower, nature-immersive experience? Swap German Village for a barefoot walk on the powdery sands of Sangju Beach, framed by centennial pine forests.
                  </p>
                  <ul className="space-y-2 text-xs text-ink-700">
                    <li className="flex gap-1.5 items-center">
                      <span className="text-gold-600">⛰️</span>
                      <span>Geumsan Boriam clifftop views</span>
                    </li>
                    <li className="flex gap-1.5 items-center">
                      <span className="text-gold-600">🌊</span>
                      <span>Darangee Village wooden suspension bridge</span>
                    </li>
                    <li className="flex gap-1.5 items-center">
                      <span className="text-gold-600">🏖️</span>
                      <span>Sangju Silver Sand Beach pine grove breeze</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-cream-200 flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-xs text-ink-600 max-w-xl text-center md:text-left">
                💡 <strong>Chauffeur Benefit:</strong> Namhae is a remote southern island with extremely sparse public transit. Booking empty taxis at steep mountain summit gates or village borders is virtually impossible. Experience all of Namhae seamlessly with our private chauffeur!
              </p>
