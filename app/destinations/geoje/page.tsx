...
const GEOJE_SPOTS = [
  {
    ...
    description: 'A picturesque, grassy hill standing on the edge of the ocean, famous for its grand traditional windmill, sweeping ocean breeze, and endless horizons.',
  ...
  },
  {
    ...
    description: 'A spectacular collection of giant, weather-worn yellow rocky cliffs layered like stairs over the deep blue sea, offering a legendary view of the coastal islands.',
    image: 'https://images.unsplash.com/photo-1548115184-bc65ee477ad3?w=800&q=80&auto=format&fit=crop',
    type: 'Natural Wonder',
  },
  {
    slug: 'oedo',
    title: 'Oedo Botania Garden',
    subtitle: 'A European Botanical Paradise on the Sea',
    description: 'A stunning, privately owned marine botanical garden built on an island, styled like a Mediterranean paradise with Greek statues, palm trees, and vibrant flowers.',
    image: '/images/destinations/geoje_oedo.png',
  ...
  },
  {
    ...
    description: 'A unique crescent beach covered entirely in smooth, round black stones that make a beautiful rattling sound as the gentle waves roll in and out.',
    image: '/images/destinations/geoje_mongdol.png',
    type: 'Scenic Beach',
  },
];

export default function GeojeDestinationsPage() {
  const mosaicImages = [
    '/images/destinations/geoje_oedo.png',
    '/images/destinations/geoje_mongdol.png',
    ...
    <div className="bg-cream-50 min-h-screen">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden bg-ink-950">
        ...
        <Container className="relative flex h-full flex-col justify-end pb-16 text-cream-50 z-10">
          ...
          <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-cream-50 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] md:text-xl">
            Korea’s second-largest island, Geoje is a paradise of towering yellow clifftops, European island gardens, whispering pebble beaches, and windy coastal hills.
          </p>
        </Container>
      </section>
        ...
        <Container>
          <header className="mb-12 max-w-3xl">
            ...
            <p className="mt-4 text-ink-600">
              Hand-picked locations that capture the raw maritime beauty and romantic island gardens of Geoje, ideal for nature lovers and landscape photographers.
            </p>
          </header>

          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            {GEOJE_SPOTS.map((spot) => (
              <Link
                key={spot.slug}
                href={`/destinations/geoje/${spot.slug}`}
      ...
      <Section tone="cream" className="border-t border-cream-200 bg-cream-100/40">
        <Container>
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <h2 className="mt-4 font-serif text-3xl font-light text-ink-900 md:text-5xl">Featured: Geoje Signature Heritage Tour</h2>
            <p className="mt-4 text-ink-600 max-w-2xl mx-auto text-sm leading-relaxed">
              We have designed the ultimate 1-day signature route along Geoje's spectacular clifftops and romantic island gardens. Experience a perfect blend of high windy ridges, smooth black pebble beaches, and floating Mediterranean botanic gardens.
            </p>
          </div>
          ...
          <div className="bg-white border border-cream-200 p-6 md:p-8 rounded-sm shadow-sm max-w-4xl mx-auto">
              ...
              <div className="flex-1 bg-cream-50/50 p-6 border border-cream-200 rounded-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-serif text-base font-semibold text-ink-900">Cliffs, Pebbles & Island Botanics</h4>
                  </div>
                  <ul className="space-y-4 text-xs text-ink-700">
                    <li className="flex gap-2">
                      <span className="text-gold-600 font-bold">09:30 AM</span>
                      <span>❶ <strong>Hakdong Pebble Beach</strong> (Smooth jet-black pebble beach walks & soothing wave melodies)</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-gold-600 font-bold">12:00 PM</span>
                      <span>❷ <strong>Oedo Botania</strong> (Passenger ferry to Mediterranean gardens, subtropical plants & Venus statues)</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-gold-600 font-bold">03:30 PM</span>
                      <span>❸ <strong>Windy Hill & Sinseondae Cliff</strong> (Dutch windmill ridge walk & layered yellow rock cliffs of the gods)</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex-1 bg-cream-50/50 p-6 border border-cream-200 rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-ink-600 leading-relaxed mb-4">
                    Geoje is a huge island. Connecting the ferry ports, pebble beaches, and clifftop lookouts on standard public buses involves multi-hour delays.
                  </p>
                  <ul className="space-y-2 text-xs text-ink-700">
                    <li className="flex gap-1.5 items-center">
                      <span className="text-gold-600">🚢</span>
                      <span>Coordination of Oedo ferry slots and tickets</span>
                    </li>
                    <li className="flex gap-1.5 items-center">
                      <span className="text-gold-600">🎒</span>
                      <span>Safe storage for heavy bags while exploring Oedo</span>
                    </li>
                    <li className="flex gap-1.5 items-center">
                      <span className="text-gold-600">🚗</span>
                      <span>Stress-free, direct clifftop driving along the coast</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-cream-200 flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-xs text-ink-600 max-w-xl text-center md:text-left">
                💡 <strong>Chauffeur Benefit:</strong> Avoid ferry terminal confusion and steep coastal parking stress. Let our local buddy driver handle the logistics while you soak in the pristine marine vistas!
              </p>
      ...
      <Section tone="cream" className="border-t border-cream-200">
        <Container className="text-center">
          <h2 className="font-serif text-3xl font-light text-ink-900">Have questions about Geoje?</h2>
